...
class PSDSEval:
    ...
    def __init__(
        ...
        self.metadata = None
        self.max_efpr = kwargs.get("max_efpr", 100) # 100 is the default value for max_efpr
    ...
    def psds(self, alpha_ct=0.0, alpha_st=0.0, en_interp=False):
        ...
        if self.max_efpr is None:
            max_efpr = np.max(tpr_efpr_curve.xp)
        else:
            max_efpr = self.max_efpr
